          ...
          <div className="gap-5 flex flex-col">
            <div>
              ...
              <h1
                ...
                className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-7xl text-white"
              >
            ...
            <div>
              <button
                style={Fonts.poppins.regular}
                className="bg-[#000000] py-4 px-15 rounded-full text-white hover:bg-black duration-[800ms]"
              >
                Try for free
              </button>
            </div>
